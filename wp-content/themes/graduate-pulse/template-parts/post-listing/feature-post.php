<div class="big-post feature-post" style="background-image: linear-gradient(rgba(20,20,20, .4), rgba(20,20,20, .4)), url('<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full')[0] ?>');">
